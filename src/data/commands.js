...
export const COMMANDS = {
  ...
  skills: {
    ...
    output: () => [
      ...
      { type: 'section', label: 'DevOps',        items: ['Azure DevOps', 'TeamCity', 'Octopus', 'Azure App Services', 'Docker'] },
      { type: 'section', label: 'Integrations',  items: ['Salesforce', 'MYOB EXO', 'Akeneo', 'Zaui', 'Narnoo'] },
