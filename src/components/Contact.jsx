...
const LINKS = [
  ...
  { label: 'Email',    icon: EmailIcon,    value: 'jban0811@gmail.com',           href: 'mailto:jban0811@gmail.com',                iconClass: 'text-terminal-green', hoverClass: 'hover:border-terminal-green/50' },
